...
private void Update()
    {
        ...
        {
            anim.SetTrigger("run"); passedTime = 0; return;
        }
        if (Input.GetKeyDown(KeyCode.S))
        {
            anim.SetTrigger("stop"); passedTime = 0; return;
        }
        if (Input.GetKeyDown(KeyCode.A))
        {
            anim.SetTrigger("runleft"); passedTime = 0; return;
        }
        if (Input.GetKeyDown(KeyCode.D))
        {
            anim.SetTrigger("runright"); passedTime = 0; return;
        }
        if (Input.GetKeyDown(KeyCode.Space))
        {
            anim.SetTrigger("jump"); passedTime = 0; return;
        }
        if (Input.GetMouseButtonDown(1))
        {
            anim.SetTrigger("crouch"); passedTime = 0; return;
        }
